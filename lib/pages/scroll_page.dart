...
import '../pages/listview_page.dart'; // 導入 ListViewPage 小部件
...
class ScrollPage extends StatelessWidget {
  ...
  final ScrollPageController controller = Get.put(ScrollPageController()); // 使用 Get.put() 創建並注入控制器
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: GridViewPage(removeLeading: true), // 放入 GridViewPage 小部件並且不顯示返回按鈕
            ),
            Container(
              height: 200, // 設置容器高度為200像素
              color: Colors.blue, // 設置容器背景顏色為藍色
              child: ListViewPage(removeLeading: true), // 放入 ListViewPage 小部件並且不顯示返回按鈕
            ),
            Container(
              height: 200, // 設置容器高度為200像素
